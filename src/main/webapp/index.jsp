...
<body class="bg-gray-100">
  ...
  <div class="fixed top-0 left-0 right-0 bg-cyan-500 p-4 z-50 h-19
    ...
    <i class="toggleSidebar fa fa-bars text-white cursor-pointer"></i>
    ...
    <div class="flex items-center space-x-2 flex-shrink-0 relative">
        <!-- Bell -->
        <div class="relative">
          <i class="fa fa-bell p-2 text-white cursor-pointer toggleSubmenuBell"></i>
          <!-- Submenu bell -->
          <div id="submenu-bell" 
        ...
        <div class="relative">
          <img src="${pageContext.request.contextPath}/assets/img/profile.jpg"
            class="rounded-full cursor-pointer toggleSubmenuProfile" width="30"
            alt="Profile">
            <!-- Submenu profile -->
    ...
    <div class="w-full">
        ...
        <div id="submenu" class="hidden text-left text-sm w-full overflow-hidden">
            ...
            <div class="cursor-pointer pr-5 rounded-md mt-1 flex items-center
                hover:bg-gray-200 hover:text-orange-600 toggleDropdown"
                data-menu="submenu2"
                data-arrow="arrow2">
            ...
            <!-- Submenu Level 2 -->
            <div id="submenu2" class="hidden mt-2 overflow-hidden transition-max-height duration-300">
